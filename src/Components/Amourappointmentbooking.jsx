...
.ae-btn-sms{
  ...
  align-items:center;
  gap:8px;
  transition:background var(--t),letter-spacing .3s
}
.ae-btn-sms:hover:not(:disabled){
  background:var(--g900);
...
.ae-btn-ol:hover:not(:disabled){
  background:var(--g50)
}
.ae-dp{
  width:100%
}
.ae-dp .react-datepicker-wrapper,
.ae-dp .react-datepicker__input-container{
  width:100%
}
.react-datepicker{
  font-family:var(--sans)!important;
...
.ae-spin{
  ...
  border-radius:50%;
  animation:ae-sp .7s linear infinite;
  flex-shrink:0
}
.ae-summ{
...
.ae-summ-row{
  ...
  padding-bottom:13px;
  margin-bottom:13px;
  border-bottom:.5px solid var(--g100)
}
.ae-summ-row:last-child{
  border-bottom:none;
  margin-bottom:0;
  padding-bottom:0
}
...
export default function AmourAppointmentBooking() {
  ...
  useEffect(() => {
    ...
    return () => {
      const style = document.getElementById('ae-css');
  ...
  const sendOtpViaSMS = async () => {
    if (
      ...
      setErrors(p => ({
        ...p,
        phone:
          'Enter a valid mobile number to receive the OTP.',
      }));
      return;
    }
    setOtpSending(true);
    ...
    try {
      ...
      setBanner({
        msg:
          `OTP sent to ${form.phone}. Enter the 6-digit code below.`,
        type: 'info',
      });
      setTimeout(() => {
      ...
      if (err?.code === 'auth/operation-not-allowed') {
        message =
          'Phone authentication is not enabled in Firebase. Please enable the Phone provider.';
      }
  ...
  const val1 = () => {
    ...
    if (!otpVerified) {
      e.otp =
        'Please verify your phone via SMS OTP before continuing.';
    }
    return e;
  };
  const val2 = () => {
  ...
  const waUrl = () => {
    if (!success) return '#';
    const m =
      `Hello Amour Estilo! Confirming my booking:\n` +
      `📌 ${success.service}\n` +
  ...
  const gcUrl = () => {
    ...
    return (
      ...
      `&dates=${success.gcalDate}/${success.gcalDate}` +
  ...
  return (
    <div className="ae">
      ...
      <div className="ae-ph">
        ...
        <p className="ae-h1-sub">
          On-Demand · Home Service · Bengaluru
        </p>
      </div>
      {/* Progress */}
      ...
      <div className="ae-card">
        ...
        {banner && (
          <div
            className={`ae-banner ${banner.type}`}
          >
            {banner.msg}
          </div>
        )}
        ...
        {step === 1 && (
          <>
            <div className="ae-sh">
              <span className="ae-si">
                I
              </span>
              <span className="ae-st">
                Contact Details
              </span>
              ...
              >
                <PhoneInput
                  ...
                  onChange={v => {
                    ...
                    // Changing phone invalidates
                    // the previous Firebase verification.
                    setOtpSent(false);
                    setOtpVerified(false);
                    setDigits([
                      '',
                ...
                !otpVerified && (
                  <div className="ae-wa-hint">
                    <div className="ae-wa-hint-top">
                      <span className="ae-wa-ic">
                        📱
                      </span>
                      <span className="ae-wa-hint-title">
          ...
          <>
            ...
            <div className="ae-summ">
              {[
                ...
                <div
                  className="ae-summ-row"
                  key={k}
                >
                  <div className="ae-summ-k">
                    {k}
                  </div>
                  <div className="ae-summ-v">
                    {v || '—'}
                  </div>
                </div>
              ))}
      ...
      {success && (
        <div className="ae-ov">
          <div className="ae-mo">
            <div className="ae-mo-ic">
              ✦
            </div>
            <div className="ae-mo-t">
